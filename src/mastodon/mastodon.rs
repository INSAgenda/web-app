...
pub fn init_mastodon(page: &Page, app_link: AppLink) -> web_sys::Element {
    ...
    iframe.set_attribute("src", "https://auth.dera.page/cas/login?service=https%3A%2F%2Fmastodon.dera.page%2Fauth%2Fauth%2Fcas%2Fcallback%3Furl%3Dhttps%253A%252F%252Fmastodon.dera.page%252Fauth%252Fsign_in").unwrap();
    ...
    if !matches!(page, Page::Mastodon) {
        ...
        let on_message = Closure::wrap(Box::new(move |e: web_sys::MessageEvent| {
            ...
            if e.origin() != "https://mastodon.dera.page/" {
